...
class HoneyBadger {
    ...
    bark() {
        console.log("The honey badger barks!");
    }
}

const myBadger = new HoneyBadger("Skunk", 25, true);
console.log(myBadger.name);
console.log(myBadger.weight);
console.log(myBadger.isFierce);
myBadger.bark();
